...
const ReusableCard: React.FC<props> = ({
  ...
  return (
    <div
      className={cn(
        "w-full h-full flex justify-center bg-[#F2F2F2] items-center py-[160px] relative px-5 z-10 overflow-hidden"
      )}>
      <Image
        src={mask}
        alt="mask"
      ...
      <div className="w-full max-w-[1313px] flex justify-center items-center relative z-10">
        <div className="w-full">
          <div className="w-full flex justify-between xl:justify-center flex-wrap items-center">
          ...
          <div className="mt-[55px] flex justify-between items-end flex-wrap mob:items-center">
            <Image src={image} alt="image" width={489} className="" />
            <div className="w-full max-w-[726px]">
                <Text className="text-[40px] font-semibold mb-[45px]">
                    {heading}
                </Text>
