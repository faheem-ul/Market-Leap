...
const SecondSection = ({ industryId }: { industryId: string }) => {
  ...
  <div className="relative z-10">
    ...
    <div className="relative  mx-auto bg-fixed bg-center bg-cover" style={{ backgroundImage: `url(${linesbg.src})`}}>
    {/* absolute inset-0 bg-black/20 z-0 pointer-events-none */}
    <Image src = {bg} alt="bg" className="absolute inset-0 h-full z-0 opacity-30 pointer-events-none"/>
