  ...
  return (
    ...
    transition-all duration-1000 cursor-pointer px-[27px] rounded-[30px]">
      <div className="relative">
        <Text className="text-[24px] font-bold font-poppins group-hover:text-black text-white mb-2">
          {planType}
        </Text>
        <Text className="text-[14px] font-light text-white group-hover:text-black">
          {PlanDescrip}
        </Text>
        <Divider className={cn("border border-[#ffffff] my-3 group-hover:border-white", inperonshow)} />

        <Text className={cn("text-[12px] font-semibold mb-3 text-white group-hover:text-black",inperonshow)}>
          Payment Processing Fee:
        </Text>
        <div className={cn(inperonshow)}>
          <div className={cn("w-full flex justify-between items-center mb-[6px]",)}>
            <Text className="text-[12px] font-light text-white group-hover:text-black">
              In-Person
            </Text>
            <Text className="text-[12px] text-white font-light group-hover:text-black">
              {inpersonValue}
            </Text>
          </div>
        ...
        <Text className="text-[24px] font-poppins font-bold text-white group-hover:text-black">
        ...
        <Text className="text-[15px] font-bold group-hover:text-black mb-[12px] text-white">Features:</Text>

        {points.map((point, index) => (
          <ul
            key={index}
            className="text-[14px] list-disc pl-5 font-light text-white group-hover:text-black font-space_grotesk">
