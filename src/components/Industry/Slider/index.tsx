...
export default function IndustrySlider() {
  ...
  return (
    <div className="flex flex-col items-center mt-10 w-full px-5">
      {/* Top Bar */}
      <div className="flex px-[42px] justify-between items-center w-full max-w-[1017px] rounded-[25px] mb-[22px] bg-secondary h-[78px] bar-shadow">
      ...
      <Swiper
        ...
        className="w-full max-w-[1313px] h-[401px] rounded-md p-6">
